...
const PROJECTS = [
  {
    ...
    description:
      "Plataforma integral para la gestión de flotas, inventarios y facturación automatizada. Reducción del 30% en tiempos operativos.",
  ...
  },
  {
    ...
    description:
      "Tienda en línea mayorista con integración de pasarelas de pago personalizadas y sincronización en tiempo real con SAP.",
  ...
  },
  {
    ...
    description:
      "Panel de visualización de datos para la toma de decisiones gerenciales, procesando millones de transacciones diarias.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Hemos ayudado a empresas a transformar sus procesos mediante
            software a la medida de alto rendimiento.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {PROJECTS.map((project, index) => (
            <Card
              key={index}
              className="flex flex-col hover:shadow-lg transition-all duration-300 border-muted-foreground/20 group"
            >
              <CardHeader>
